...
Важно: я поставил номер 799965126282 именно таким, как ты указал для мессенджеров. Если там должна быть одна лишняя/пропущенная цифра, скажи — поменяю во всём коде.

Могу также сделать, чтобы после таймера появлялись отдельные красивые кнопки WhatsApp и MAX.
